...
def get_cohesions():
    jsonl_file = "./partisan_election_results.jsonl"
...
def get_num_rep_win(election_df):
    ...
    num_winners = [0,0,0,0] #0th element is 0 rep wins, 1st ele is 1 rep win, etc
...
cohesion = 1
for i in cohesions:
    filtered_df = filter_df(election_df, 3,percent,i)
...
print(rep_wins)
plt.savefig("STV_Three_Winners.png")
plt.show()
